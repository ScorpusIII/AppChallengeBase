  ...
  const component = import_react.default.forwardRef((propsIn, forwardedRef) => {
    ...
    if (context && (contextValue = import_react.default.useContext(context), contextValue)) {
      ...
      for (const key in context.props) {
        const propVal = (0, import_getShorthandValue.getShorthandValue)(propsIn, key);
        if (propVal === void 0) {
    ...
    const hasTextAncestor = !!(import_constants.isWeb && isText && componentContext.inText), isTaggable = !Component || typeof Component == "string", tagProp = props.tag, element = import_constants.isWeb && isTaggable && tagProp || Component;
    ...
    if ("themeInverse" in props && (themeStateProps.inverse = props.themeInverse), "theme" in props && (themeStateProps.name = props.theme), typeof curStateRef.isListeningToTheme == "boolean" && (themeStateProps.needsUpdate = () => !!stateRef.current.isListeningToTheme), process.env.NODE_ENV === "development" && debugProp && debugProp !== "profile") {
      ...
      if (console.info(
        ...
        childLog.length && (childLog = `(children: ${childLog})`), (0, import_consoleLog.groupCollapsed)(`${childLog} Props:`), (0, import_log.log)("props in:", propsIn), (0, import_log.log)("final props:", props), (0, import_log.log)({ state, staticConfig, elementType, themeStateProps }), (0, import_log.log)({ contextProps: styledContextProps, overriddenContextProps }), (0, import_log.log)({ presence, isAnimated, isHOC, hasAnimationProp, useAnimations }), (0, import_consoleLog.groupEnd)();
      }
    }
...
` && console.error(
    ...
    process.env.NODE_ENV === "development" && import_constants.isWeb && (0, import_constants.useIsomorphicLayoutEffect)(() => {
      ...
      const dispose = pseudoGroups || mediaGroups ? (0, import_subscribeToContextGroup.subscribeToContextGroup)({
        componentContext,
        setStateShallow,
        state,
        mediaGroups,
    ...
    if (("group" in props || propsIn.focusWithinStyle) && (content = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ...
    )), process.env.NODE_ENV === "development" && time && time`group-context`, content = disableTheme ? content : (0, import_Theme.getThemedChildren)(themeState, content, themeStateProps, !1, stateRef), process.env.NODE_ENV === "development" && time && time`themed-children`, isReactNative && !asChild && (content = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "span",
      {
  ...
  function styleable(Component2, options) {
    ...
    return out = options?.disableTheme ? out : (0, import_themeable.themeable)(out, extendedConfig, !0), process.env.TAMAGUI_MEMOIZE_STYLEABLE && (out = import_react.default.memo(out)), out.staticConfig = extendedConfig, out.styleable = styleable, out;
  }
