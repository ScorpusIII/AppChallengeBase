...
function createComponent(staticConfig) {
  ...
  var component = /* @__PURE__ */ import_react.default.forwardRef(function(propsIn, forwardedRef) {
    ...
    process.env.NODE_ENV === "development" && import_constants.isClient && import_react.default.useEffect(function() {
    ...
    var isStringElement = typeof elementType == "string", mediaState = (0, import_useMedia.useMedia)(componentContext, debugProp);
...
` && console.error(`Unexpected text node: ${item}. A text node cannot be a child of a <${staticConfig.componentName || propsIn.tag || "View"}>.`, props);
    ...
    import_setupHooks.hooks.useChildren && (useChildrenResult = import_setupHooks.hooks.useChildren(elementType, content, viewProps)), process.env.NODE_ENV === "development" && time && time`use-children`, useChildrenResult ? content = useChildrenResult : content = /* @__PURE__ */ import_react.default.createElement(elementType, viewProps, content);
    ...
    if (("group" in props || propsIn.focusWithinStyle) && (content = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ComponentContext.ComponentContext.Provider, {
      ...
      children: content
    })), process.env.NODE_ENV === "development" && time && time`group-context`, content = disableTheme ? content : (0, import_Theme.getThemedChildren)(themeState, content, themeStateProps, !1, stateRef), process.env.NODE_ENV === "development" && time && time`themed-children`, staticConfig.context) {
  ...
  function styleable(Component2, options) {
    ...
    return out = options != null && options.disableTheme ? out : (0, import_themeable.themeable)(out, extendedConfig, !0), process.env.TAMAGUI_MEMOIZE_STYLEABLE && (out = /* @__PURE__ */ import_react.default.memo(out)), out.staticConfig = extendedConfig, out.styleable = styleable, out;
  }
