...
import { devConfig, onConfiguredOnce } from "./config.native.js";
...
import { groupCollapsed, groupEnd } from "./helpers/consoleLog.native.js";
import { getShorthandValue } from "./helpers/getShorthandValue.native.js";
...
function createComponent(staticConfig) {
  ...
  var component = /* @__PURE__ */React.forwardRef(function (propsIn, forwardedRef) {
    ...
    var splitStyles = useSplitStyles(props, staticConfig, theme, themeName, state, styleProps, null, componentContext, elementType, debugProp);
...
` && console.error(`Unexpected text node: ${item}. A text node cannot be a child of a <${staticConfig.componentName || propsIn.tag || "View"}>.`, props);
    ...
    process.env.NODE_ENV === "development" && isWeb && useIsomorphicLayoutEffect(function () {
      ...
      if (!disabled) {
        ...
        if (state.unmounted) {
          ...
          if ((_animationDriver_supportsCSSVars = animationDriver?.supportsCSSVars) !== null && _animationDriver_supportsCSSVars !== void 0 ? _animationDriver_supportsCSSVars : !(config == null || (_config_animations2 = config.animations) === null || _config_animations2 === void 0) && _config_animations2.supportsCSSVars) return tm = setTimeout(function () {
            setStateShallow({
              unmounted: !1
            });
          }), function () {
        ...
        var dispose = pseudoGroups || mediaGroups ? subscribeToContextGroup({
          componentContext,
          setStateShallow,
          state,
          mediaGroups,
    ...
    }, [state.unmounted, disabled, pseudoGroups ? Object.keys([...pseudoGroups]).join("") : 0, mediaGroups ? Object.keys([...mediaGroups]).join("") : 0]), useIsomorphicLayoutEffect(function () {
      ...
      if (groupName) {
        ...
        var groupContextState = componentContext?.groups;
    ...
    if (("group" in props || propsIn.focusWithinStyle) && (content = /* @__PURE__ */_jsx(ComponentContext.Provider, {
      ...componentContext,
      groups: subGroupContext,
      setParentFocusState: setStateShallow,
      children: content
    })), process.env.NODE_ENV === "development" && time && time`group-context`, content = disableTheme ? content : getThemedChildren(themeState, content, themeStateProps, !1, stateRef), process.env.NODE_ENV === "development" && time && time`themed-children`, staticConfig.context) {
  ...
  function styleable(Component2, options) {
    ...
    return out = options?.disableTheme ? out : themeable(out, extendedConfig, !0), process.env.TAMAGUI_MEMOIZE_STYLEABLE && (out = /* @__PURE__ */React.memo(out)), out.staticConfig = extendedConfig, out.styleable = styleable, out;
  }
